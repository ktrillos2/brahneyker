...
interface Appointment {
  ...
  duration: number
  details: string
  stylist: "Damaris" | "Fabiola" | "Zulay" | "Lizday" | "Stella"
...
const stylists = ["Damaris", "Fabiola", "Zulay", "Lizday", "Stella"] as const
...
export default function CitasPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    duration: 60,
    details: "",
    stylist: "Damaris" as "Damaris" | "Fabiola" | "Zulay" | "Lizday" | "Stella",
  })
  ...
  const handleOpenModal = (
    ...
    if (appointment) {
      ...
      setFormData({
        ...
        stylist: appointment.stylist as "Damaris" | "Fabiola" | "Zulay" | "Lizday" | "Stella",
      })
    } else {
